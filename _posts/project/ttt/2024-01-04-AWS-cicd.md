...
책에서는 Travis CI로 CI를 했고, 블로그들에는 수없이 많은 정보가 흩어져 있었다. AWS 공식 문서도 따라가보며 수도 없이 머리 박으며 했다... 심지어 블로그 쓰다가 오류 발견해서 또 3시간 가량 수정함,,,,,,,,  
![이미지](https://manchott.github.io/assets/img/AWS-cicd/tries.png "수많은 시도의 흔적"){: width="635" } 
